...
//
//     findByHash(hash) {
//         logger.info(` [findByHash] attempt to load verification code by hash
//             \nhash: ${stringify(hash)}`);
//
//         return this._model.findOne({hash}, this._fields);
//     }
//
//     deleteById(verificationCodeId) {
//         logger.info(`[deleteById] attempt to delete verification code by id
...
//         logger.info(`[newVerificationCode] attempt to create new verification code
